...
public class UserPolicyAmountValidation {
	...
	public boolean UserAmountValidate(@PathVariable("userid") String userid,@PathVariable("policyId") String policyId, int termamt,int numOfterms)

	{
		...
		int sum1=sum+(termamt*numOfterms);
	
		double annual_income=ueps.get(0).getUser().getSalary();
		if(sum1<(0.4*annual_income))
		{
			//String msg=""
